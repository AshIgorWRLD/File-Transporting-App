...
public class Client {
    ...
    private boolean sendFileName(DataInputStream dataInputStream,
    ...
    private void sendFileContent(FileInputStream inputStream, DataInputStream dataInputStream,
                                 DataOutputStream dataOutputStream) throws IOException {
        ...
        if (response == protokolCodes.
            ...
            log.info("FILE SUCCESSFULLY TRANSPORTED");
        }
    }
}
